...
const TroncalsResultsTable = () => {
  ...
  const handleScroll = () => {
    ...
    const element = document.getElementById('div-troncal-table');
    const tolerance = 1;
              ...
              <tbody>
                {results.map((troncal, index) => (
                  <tr
                    ...
                    <td className='border-x px-5'>{troncal.number}</td>
                    <td className='border-x px-5'>{troncal.transport_type.description}</td>
                    <td className={`border-x px-6`}>{troncal.restriction.description}</td>
...
export default TroncalsResultsTable;

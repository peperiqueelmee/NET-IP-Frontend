			...
			<Grow
				...
				<div className={`pb-14 ${selectedAction === 0 ? 'block' : 'hidden'} `}>
					...
					<div
						...
						<div className='border border-lime-400 rounded-lg flex flex-col items-center justify-evenly py-2 px-4 text-xs lg:text-sm gap-y-1 font-medium'>
							<div className='flex items-center gap-3'>
								...
								<div style={{ marginTop: '3px' }}>
									<InfoTooltip info={'Ingresa solo los 9 números después del +56'} />
								</div>
							</div>
							<form
								...
								<input
									...
									type='text'
									placeholder='Ingresa solo los 9 dígitos'
								/>
								<button
									type='submit'
									onClick={() => {
						...
						{/* User Management */}
						<div className='border border-lime-400 rounded-lg flex flex-col items-center justify-evenly py-2 px-4 text-xs lg:text-sm gap-y-1 font-medium'>
							<div className='text-lime-400'>Reporte</div>
							<button
								className={`bg-gray-200 text-zinc-200 rounded-2xl px-4 py-1 
								            text-xs lg:text-sm shadow hover:shadow-red-400 w-11/12 sm:w-6/12 lg:w-32
